...
namespace OnlineShop.Model
{
    public class AppDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        //now add the tables
        //also add connection string in appsettings
        ...
        // seeding is method to add/iNSERT  the data through code TO database
        //for that we use HASDATa FUNCTION
        //once seeded do data maigration through package maanger
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            base.OnModelCreating(modelBuilder);

            //seed categories //ie inserting data
